...
public class Main {
    ...
    public static void generateData(Node tree) {
        tree.addEntry(false,
                new AbstractMap.SimpleEntry<>("ciel", new Pair<>(0, "Soleil")),
        ...
        tree.addEntry(true,
                new AbstractMap.SimpleEntry<>("ciel", new Pair<>(1, "Couvert")),
                new AbstractMap.SimpleEntry<>("temperature", new Pair<>(0, "Normale")),
                new AbstractMap.SimpleEntry<>("humidite", new Pair<>(0, "Normale")),
                new AbstractMap.SimpleEntry<>("vent", new Pair<>(0, "Faible"))
        );
        tree.addEntry(true,
                new AbstractMap.SimpleEntry<>("ciel", new Pair<>(2, "Pluie")),
        ...
        tree.addEntry(true,
                ...
                new AbstractMap.SimpleEntry<>("humidite", new Pair<>(1, "Elevee")),
                new AbstractMap.SimpleEntry<>("vent", new Pair<>(0, "Faible"))
        );
